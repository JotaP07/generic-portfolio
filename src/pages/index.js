    ...
    return (
        <>
            ...
            <main className="flex items-center text-dark w-full min-h-screen dark:text-light">
                <Layout className="pt-0 md:-mt-16 sm:pt-8 lg:-mt-20 xl:pt-0 sm:-mt-32 sm:pb-0 xs:-mt-32 xs:pb-0">
                ...
                <div className="absolute right-8 bottom-8 w-24 h-auto">
                    <Image src={lightBulb} alt="your name" className="w-full h-auto md:hidden"/>
                </div>
                <div className="hidden md:inline-block absolute top-3.5 sm:-right-4 xs:-right-5 md:right-0 bottom-0 w-24 h-auto sm:top-5">
