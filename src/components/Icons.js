...
export const CatComponent = (props) => (
    ...
    >
        <title>{"cat"}</title>
        <path
            d="m28.926 1.17-2.182 3.608c-1.876-.608-4.669-.489-6.426 0l-2.102-3.557c-3.452 6.448-2.475 10.523.159 12.549a26.02 26.02 0 0 0-1.247.833C6.149 5.844-3.735 15.709 2.749 24.523h.05c1.163 1.687 2.503 2.731 3.95 3.277 2.05.773 4.159.551 6.236.257s4.109-.663 6.046-.525c1.937.138 3.874.635 5.647 2.569 1.209 1.318 2.926-.101 1.486-1.507-2.185-2.134-4.525-2.959-6.825-3.122s-4.505.293-6.502.576c-1.997.283-3.761.409-5.276-.163a5.728 5.728 0 0 1-2.07-1.36h22.51c1.064-3.756 1.177-7.73-.033-10.237 3.635-1.897 5.097-6.376.958-13.116zm-6.75 9.702c-2.316 1.117-3.367.212-3.817-1.656 2.273-1.41 3.626-.278 3.817 1.656zm2.891 0c.191-1.934 1.544-3.067 3.817-1.656-.45 1.868-1.502 2.774-3.817 1.656z"/>
    </svg>
)
...
const LogoJp = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" {...props}>
        <path
            d="M11.203 2.027c-.473.926-.98 1.965-1.137 2.313-.261.598.032 1.258 5.938 13.203 3.422 6.918 6.219 12.676 6.219 12.8 0 .15-2.575.227-7.332.227-4.036 0-7.336-.054-7.336-.12 0-.067.508-1.2 1.125-2.52.62-1.317 1.144-2.457 1.168-2.532.074-.253-1.926-4.496-2.118-4.496-.222 0-6.62 12.97-6.62 13.418 0 .242 2.546.297 13.89.297 7.64 0 13.883-.078 13.875-.172-.004-.09-3.793-7.8-8.414-17.133L12.059.345l-.856 1.683m9.848 7.325c-.14.144 16.523 34.03 16.734 34.03.067 0 .602-.991 1.192-2.202l1.07-2.2L33.8 26.348c-3.434-6.95-6.246-12.688-6.246-12.746 0-.063 3.3-.114 7.336-.114 4.03 0 7.332.051 7.332.114 0 .066-.547 1.218-1.211 2.562l-1.215 2.441 1.031 2.16c.567 1.192 1.113 2.16 1.211 2.16.254 0 6.86-13.402 6.691-13.57-.18-.18-27.503-.183-27.68-.003"
        />
    </svg>
)
